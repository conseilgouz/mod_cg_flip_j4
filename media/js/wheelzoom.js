...
window.wheelzoom = (function(){
	...
	var main = function(img, options){
		...
		function load() {
			...
			// pascal
			if (computedStyle.width.indexOf('%') > 0)
				width = parseInt(window.getComputedStyle(img.parentNode, null).width, 10);
			else
				width = parseInt(computedStyle.width, 10);
			if (computedStyle.height.indexOf('%') > 0)
				height = parseInt(window.getComputedStyle(img.parentNode, null).height, 10);
			else
